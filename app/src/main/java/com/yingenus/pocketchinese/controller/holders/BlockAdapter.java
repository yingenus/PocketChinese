package com.yingenus.pocketchinese.controller.holders;
...
public abstract class BlockAdapter<BockHolder extends RecyclerView.ViewHolder,ItemHolder extends RecyclerView.ViewHolder> extends RecyclerView.Adapter{
    ...
    abstract BockHolder onCreateBlockHolder(@NonNull ViewGroup parent);
    abstract ItemHolder onCreateItemHolder(@NonNull ViewGroup parent);
    ...
    abstract void onBindBlockHolder(BockHolder holder, int blockNumber);
    abstract void onBindItemHolder(ItemHolder holder, int blockNumber, int inBlockPosition);
