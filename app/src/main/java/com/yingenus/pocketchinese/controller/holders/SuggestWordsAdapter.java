...
public class SuggestWordsAdapter extends BlockAdapter<SuggestWordsAdapter.BlockHeaderHolder, SuggestWordsAdapter.SuggestItemHolder> {
    ...
    @Override
    BlockHeaderHolder onCreateBlockHolder(@NonNull ViewGroup parent) {
    ...
    @Override
    SuggestItemHolder onCreateItemHolder(@NonNull ViewGroup parent) {
    ...
    @Override
    void onBindBlockHolder(BlockHeaderHolder holder, int blockNumber) {
    ...
    @Override
    void onBindItemHolder(SuggestItemHolder holder, int blockNumber, int inBlockPosition) {
