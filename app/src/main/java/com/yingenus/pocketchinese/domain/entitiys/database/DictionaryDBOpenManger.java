 ...
 */
public class DictionaryDBOpenManger {

	private static final String HELPER_CLASS_RESOURCE_NAME = "open_helper_classname";
	private static Logger logger = LoggerFactory.getLogger(DictionaryDBOpenManger.class);
	...
	public static synchronized void setHelper(OrmLiteSqliteOpenHelper helper) {
		DictionaryDBOpenManger.helper = helper;
	}
