...
class RepeatableUserListsPresenter(val view : UserListsInterface){
    ...
    private fun updateLists(){
        val observable = Observable.fromIterable( listDAO.getAll())
            ...
            .filter { it.expered != UserListsInterface.Expired.GOOD && it.expered != UserListsInterface.Expired.NON }
