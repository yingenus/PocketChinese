...
import com.yingenus.pocketchinese.view.activity.SingleFragmentActivityWithActionBar
...
class StudyListActivity: SingleFragmentActivityWithActionBar() {
    ...
    override fun createFragment(): Fragment {
        return supportFragmentManager.fragmentFactory.instantiate(classLoader,
            StudyListFragment::class.java.name)
    }

    private fun createFragmentFactory(savedInstanceState: Bundle?): FragmentFactory{
        val uuid = (if (savedInstanceState != null && savedInstanceState.containsKey(
                INNER_STUDY_LIST
            ))
