...
class NewRepeatableUserListsActivity : AppCompatActivity(),StudyListAdapter.OnUserListClicked {

    companion object{
        fun getIntent(context: Context): Intent {
            return Intent(context, NewRepeatableUserListsActivity::class.java)
        }
    }
