...
import com.yingenus.pocketchinese.domain.entitiys.dictionary.DictionarySearch
import com.yingenus.pocketchinese.domain.entitiys.dictionary.Language
...
class DictionaryPresenter @AssistedInject constructor(
    ...
    private  val chinCharRepository: ChinCharRepository) {
