...
class CharacterSheetDialog(
    ...
    @Inject
    lateinit var characterPresenterFactory : CharacterPresenter.Factory
    private lateinit var presenter : CharacterPresenter
        //CharacterPresenter(this,chinChar?.id?:1,chinCharRepository, exampleRepository,toneRepository)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?
        ...
        view.findViewById<View>(R.id.container)
                .minimumHeight = getPagerOccupiHeight(dp2px(0,inflater.context),
            Helper.occupiHeight
        )
